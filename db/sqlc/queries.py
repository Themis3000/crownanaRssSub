...
ADD_TIME_TO_ALL_LAST_NOTIFICATION = """-- name: add_time_to_all_last_notification \\:exec
UPDATE subscriptions
    SET last_notification_time = last_notification_time + :p1\\:\\:interval,
        last_process_update = last_process_update + :p1\\:\\:interval
"""
...
class Querier:
    ...
    def add_time_to_all_last_notification(self, *, timedelta: datetime.timedelta) -> None:
        self._conn.execute(sqlalchemy.text(ADD_TIME_TO_ALL_LAST_NOTIFICATION), {"p1": timedelta})
